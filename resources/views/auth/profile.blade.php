...
<main class="d-flex align-items-center min-vh-100 py-3 py-md-0">
    <div class="cont over-size">
      ...
      <div class="card-body" >
        <div class="container">
            <div class="row" > 
                <div class="col-md-12 col-md-offset-1 flex">
                    <div>
                    <img src="{{asset('storage/'.$user->avatar_path)}}" style="width:150px; height:150px; float:left; border-radius:50%; margin-right:25px;"> 
                    </div>
                    <div>
                    <h2 class="text-uppercase  " >{{$user->lastname}} {{$user->firstname}}</h2>
                    <li class="flex"><p class="left00 ">Phone number : </p> <p> {{$user['phone_number']}} </p>
                      </li>
                        <li  class=" flex" > <p class="left02">Fax : </p><p>{{$user['fax']}}</p>
                        </li>
                        <li class=" flex"> <p class="left02" ><a href="{{'/bases/user/'.$user->id}}" target="_blank" rel="noopener noreferrer">My Researches</a></p>
                        </li>
                    </div>       
                </div>
            </div>   
        ...
        <div>
           <section class="page-section clearfix" style="margin-top:-20px">
